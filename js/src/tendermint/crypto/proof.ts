...
export const Proof = {
  ...
  toJSON(message: Proof): unknown {
    ...
    message.leafHash !== undefined &&
      (obj.leafHash = base64FromBytes(message.leafHash !== undefined ? message.leafHash : new Uint8Array(0)));
    if (message.aunts) {
      obj.aunts = message.aunts.map((e) => base64FromBytes(e !== undefined ? e : new Uint8Array(0)));
    } else {
      obj.aunts = [];
    }
    return obj;
