...
class QueryStub(betterproto.ServiceStub):
    async def code_info(
        self,
        query_code_info_request: "QueryCodeInfoRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ...
    async def byte_code(
        self,
        query_byte_code_request: "QueryByteCodeRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ...
    async def contract_store(
        self,
        query_contract_store_request: "QueryContractStoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
    ...
    async def raw_store(
        self,
        query_raw_store_request: "QueryRawStoreRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
...
class QueryBase(ServiceBase):
    ...
    async def byte_code(
        self, query_byte_code_request: "QueryByteCodeRequest"
    ) -> "QueryByteCodeResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def contract_store(
        self, query_contract_store_request: "QueryContractStoreRequest"
    ) -> "QueryContractStoreResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def raw_store(
        self, query_raw_store_request: "QueryRawStoreRequest"
    ) -> "QueryRawStoreResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_code_info(
        self,
        stream: "grpclib.server.Stream[QueryCodeInfoRequest, QueryCodeInfoResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.code_info(request)
        await stream.send_message(response)

    async def __rpc_byte_code(
        self,
        stream: "grpclib.server.Stream[QueryByteCodeRequest, QueryByteCodeResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.byte_code(request)
        await stream.send_message(response)
    ...
    async def __rpc_contract_store(
        self,
        stream: "grpclib.server.Stream[QueryContractStoreRequest, QueryContractStoreResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.contract_store(request)
        await stream.send_message(response)

    async def __rpc_raw_store(
        self,
        stream: "grpclib.server.Stream[QueryRawStoreRequest, QueryRawStoreResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.raw_store(request)
        await stream.send_message(response)
