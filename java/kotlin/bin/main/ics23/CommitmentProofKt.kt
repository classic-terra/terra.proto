...
public val ics23.Proofs.CommitmentProofOrBuilder.existOrNull: ics23.Proofs.ExistenceProof?
  get() = if (hasExist()) getExist() else null

public val ics23.Proofs.CommitmentProofOrBuilder.nonexistOrNull: ics23.Proofs.NonExistenceProof?
  get() = if (hasNonexist()) getNonexist() else null

public val ics23.Proofs.CommitmentProofOrBuilder.batchOrNull: ics23.Proofs.BatchProof?
  get() = if (hasBatch()) getBatch() else null

public val ics23.Proofs.CommitmentProofOrBuilder.compressedOrNull: ics23.Proofs.CompressedBatchProof?
