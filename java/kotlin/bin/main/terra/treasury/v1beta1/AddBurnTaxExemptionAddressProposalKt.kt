...
@kotlin.jvm.JvmName("-initializeaddBurnTaxExemptionAddressProposal")
public inline fun addBurnTaxExemptionAddressProposal(block: terra.treasury.v1beta1.AddBurnTaxExemptionAddressProposalKt.Dsl.() -> kotlin.Unit): terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal =
  terra.treasury.v1beta1.AddBurnTaxExemptionAddressProposalKt.Dsl._create(terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal.newBuilder()).apply { block() }._build()
public object AddBurnTaxExemptionAddressProposalKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal.copy(block: terra.treasury.v1beta1.AddBurnTaxExemptionAddressProposalKt.Dsl.() -> kotlin.Unit): terra.treasury.v1beta1.Gov.AddBurnTaxExemptionAddressProposal =
  terra.treasury.v1beta1.AddBurnTaxExemptionAddressProposalKt.Dsl._create(this.toBuilder()).apply { block() }._build()
